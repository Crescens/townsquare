...
describe('the <Card /> component', function() {
    ...
    describe('when rendered with a card', function() {
        ...
        describe('that is booted', function() {
            beforeEach(function() {
                this.card.booted = true;

                this.component = ReactDOM.render(<Card card={this.card} source='hand' />, this.node);
            });

            afterEach(function() {
                this.card.booted = undefined;
            });

            it('should add the booted styling to the card', function() {
                ...
                expect(cardImage.className).toContain('booted');
            });
        });
    });
