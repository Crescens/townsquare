...
class RevealLowball extends BaseStep {
    constructor(game, drawhand) {
        super(game);
    ...
    continue() {
        ...
        this.game.raiseMergedEvent('onPlotsRevealed', params, () => {
            ...
            //Leaving this here, this is how they're handling different language timing windows
