    ...
    render() {
        return (
            <div className={ this.props.active ? 'deck-row active' : 'deck-row' } key={ this.props.deck.name } onClick={ this.props.onClick }>
                <div className='col-xs-1 deck-image'><img className='card-small' src={ '/img/cards/' + this.props.deck.outfit.code + '.jpt' } /></div>
                ...
                <div className='row small'>
                    <span className='col-md-7 deck-outfitlegend'>{ this.props.deck.outfit.name }{ this.props.deck.legend && this.props.deck.legend.title ? <span>/{ this.props.deck.legend.title }</span> : null }</span>
