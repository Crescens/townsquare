...
class Location extends React.Component {
    ...
    /*Not moveable by user
    onCardDragStart(event, location, source) {
    ...
    */
    ...
    onClick(event, location) {
        ...
        if(this.isAllowedMenuSource() && !_.isEmpty(this.props.location.menu)) {
    ...
    onMenuItemClick(menuItem) {
        if(this.props.onMenuItemClick) {
            this.props.onMenuItemClick(this.props.location, menuItem);
            this.setState({showMenu: !this.state.showMenu});
        }
    }

    /* -- No location specific counters
    ...
    /* -- Attachments should probably always be on the card itself
    getAttachments() {
    ...
    showMenu() {
        ...
        if(!this.props.location.menu || !this.state.showMenu) {
            return false;
        }
    ...
    /* -- No face down location
    isFacedown() {
        return this.props.card.facedown || !this.props.card.code;
    }
    */

    /* -- Unsure if I'll need this to return the location's "card" or what the props will look like
    getCard() {
        var cardClass = 'card';
